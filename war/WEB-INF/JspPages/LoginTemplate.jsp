...
<body>
	...
	<div class="container">
							...
							<div class="collapse navbar-collapse"
								...
								<ul class="nav navbar-nav navbar-right">
									<li class="dropdown"><a href="#" class="dropdown-toggle"
										data-toggle="dropdown"><%=session.getAttribute("EmployeeName") %><strong class="caret"></strong></a>
										<ul class="dropdown-menu">
										<%if(session.getAttribute("role")=="TeamLeader"||session.getAttribute("role")=="Administrator"){ %>
											<li><a href="/UserProfile.com">Profile</a></li>
						...
						<div class="row clearfix">
							<div class="col-md-2 column">
									...
									<strong class="caret"></strong></a>
										<ul class="dropdown-menu">
										<li class="active"><a href="/UserProfile.com">Profile</a></li>
										<li><a href="/Logout.com">Logout</a></li></ul></li></ul>
									<%if(session.getAttribute("role")=="TeamLeader"||session.getAttribute("role")=="Administrator"){ %>
									<ul class="nav nav-list">
									<li class="dropdown">
									<a href="#" class="dropdown-toggle"	data-toggle="dropdown">
										Employees<strong class="caret"></strong></a>
										<ul class="dropdown-menu">
										<li><a href="/Register.com">AddEmployee</a></li>
										<li><a href="#">UpdateEmployeeDetails</a></li>
										<li><a href="#">DeleteEmployee</a></li>
										</ul></li></ul>									
									<%} %>
									<ul class="nav nav-list">
									<li class="dropdown">
									<a href="#" class="dropdown-toggle"	data-toggle="dropdown">
										LeaveRequest<strong class="caret"></strong></a>
										<ul class="dropdown-menu">										
										<li><a href="/LeaveHistory">LeaveHistory</a></li>
										<li><a href="/LeaveRequest.com">LeaveRequest</a></li>
										<li><a href="/UpdateStatus.com">PendingLeaveRequest</a></li>
										</ul></li>
									</ul>
							...
							<div class="col-md-10 column">
								<div class="span9"
									style="align: center; margin-left: 75px; ">
										...
										<div class="item active">
												...
												<div class="carousel-caption">
													<marquee  direction="down" behavior="alternate"
														...
														<h3><p>Welcome To Adaptavant</p><img
									src="/Images/Logo.png" alt=" " class="img-rounded" style="height:350px;width:450px;"/></h3>
											...
											<div class="item ">
												...
												<marquee  direction="down" behavior="alternate"
													...
													<p style="text-align: justify">Adaptavant is a
														...
														operations in Australia, North America, Asia, and Europe
														to tackle complex business issues and navigate new
														markets.</p>
		...
		<div class="row clearfix" >
			...
			<hr>
					<div class="footer">
						<p class="navbar-text pull-right">© Adaptavant 2008</p>
					</div>
			</div>
		</div>
	</nav>
